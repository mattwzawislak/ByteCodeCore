 ...
 * @author Obicere
 */
public class ConstantMethodRef extends ConstantRef<Method> {
    ...
    public ConstantMethodRef(final ConstantPool constantPool, final int classIndex, final int nameAndTypeIndex) {
