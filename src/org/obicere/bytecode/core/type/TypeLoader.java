...
import org.obicere.bytecode.core.type.path.ClassPath;
...
public final class TypeLoader implements TypeRepository {
    ...
    private void installDefaults() {
        ...
        // void
        types.put("void", VoidType.getInstance());
        ...
        // void
        types.put("V", VoidType.getInstance());
    ...
    private Type loadType(final String name) {
        ...
        if (name.startsWith("[")) {
            ...
            newType = new ArrayType(componentType);
